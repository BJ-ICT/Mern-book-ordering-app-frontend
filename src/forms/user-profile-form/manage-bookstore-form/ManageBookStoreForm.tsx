...
const ManageBookStoreForm = ({onSave, isLoading, bookstore}: Props) => {
    ...
    const bookItemsFormatted = bookstore.bookItem.map ((item)=>({
        ...item,
    ...
    formDataJson.bookItem.forEach((bookItem, index)=> {
        formData.append(`bookItem[${index}][name]`,bookItem.name);
